...
class DescriptionActivity : AppCompatActivity() {
    ...
    var bookNameforcart : String? ="default book"
    var bookpriceforcart :String?= "100"
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent != null) {
            ...
            bookNameforcart = intent.getStringExtra("bookName")
        } else {
            finish()
            Toast.makeText(
                ...
                object : JsonObjectRequest(Request.Method.POST, url, jsonParams, Response.Listener {
                    ...
                    try {
                        ...
                        if (success) {
                            ...
                            var bookstringchange = txtBookName.text.toString()
                            btnAddtoCart.setOnClickListener {
                                // Create an Intent to navigate to the CartActivity
                                val intent = Intent(this@DescriptionActivity, CartActivity::class.java)

                                // Pass relevant data as extras to the intent
                                intent.putExtra("book_name", bookstringchange)
                                intent.putExtra("book_price", txtBookPrice.text.toString())

                                // Extract the book name and log it
                                val receivedBookName = intent.getStringExtra("book_name")
                                val receivedBookPrice = intent.getStringExtra("book_price")

                                Log.e("desciption", "Book Name in desciptionview: $receivedBookName")
                                Log.e("desciption", "Book Price in desciptionview: $receivedBookPrice")
